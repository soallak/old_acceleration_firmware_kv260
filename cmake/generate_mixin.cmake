...
set(TEMPLATE_MIXIN "${CMAKE_BINARY_DIR}/kv260-soallak.mixin.template")
...
set(MIXIN "${MIXIN_DIR}/kv260-soallak.mixin")
...
# enable mixins
run("${TESTFIRMWARE} colcon mixin remove kv260-soallak 2> /dev/null")  # clean up prior stuff
set(ADD_MIXIN_PATH "file://${FIRMWARE_DIR}/mixin/index.yaml")
run("${TESTFIRMWARE} colcon mixin add kv260-soallak ${ADD_MIXIN_PATH}")
# message("ADD_MIXIN_PATH: " ${ADD_MIXIN_PATH})
run("${TESTFIRMWARE} colcon mixin update kv260-soallak")
